package com.example.lab_mobile.utils.ui
...
import com.example.lab_mobile.auth.TAG
import com.example.lab_mobile.utils.helpers.hasNotificationPermission
...
fun showSyncCompletedNotification(
    ...
    val builder = NotificationCompat.Builder(context, SYNC_CHANNEL_ID)
        .setSmallIcon(R.drawable.stat_notify_sync) // Using system sync icon
